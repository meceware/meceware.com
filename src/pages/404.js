        ...
        <Section>
          <div className = 'p-1 sm:p-6 lg:p-48'>
            <div className = 'relative rounded-lg block sm:flex items-center bg-gray-100 shadow-xl'>
              <div className = 'relative w-full border-solid border-gray-400 border-b-8	sm:border-none sm:w-3/12 md:w-4/12 h-full overflow-hidden mr-0 pb-4 sm:pb-0 sm:mr-16'>
              ...
              <div className = 'w-full sm:w-9/12 md:w-8/12 h-full flex items-center bg-gray-100 rounded-lg justify-center sm:justify-start'>
                <div className = 'p-8 text-center sm:text-left sm:pr-8 sm:pl-16 sm:py-8'>
                  ...
                  <p className = 'text-gray-600 mt-2'>It looks like the page you are looking for isn&apos;t in the system.</p>
                  <Link to = '/' className = 'flex items-center justify-end mt-3 text-yellow-600 hover:text-yellow-600 focus:text-yellow-600'>
