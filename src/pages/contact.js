    ...
    superagent
      ...
      .end( ( err, res ) => {
        ...
        if ( res.body && res.body.result === 'error' ) {
          ...
          this.setState( {
            messageSent: false,
            messageError: 'ERROR: Sometimes, something happens and nothing happens!',
          } );
        } else {
          this.setState( {
            messageSent: true,
                ...
                { ( ! this.state.formValidated || this.state.messageSending ) && (
                  <form id = 'contact-form' onSubmit = { this.handleSubmit }>
                    <div className = 'mb-4'>
                      ...
                      <input name = 'name' type = 'text' placeholder = 'Your Name' data-validate className = 'appearance-none block w-full bg-gray-100 text-grey-darker border border-blue-500 rounded py-3 px-4 mb-1' />
                    ...
                    <div className = 'hidden mb-4'>
                      ...
                      <input name = 'email' type = 'email' placeholder = 'Your Email' className = 'appearance-none block w-full bg-gray-100 text-grey-darker border border-blue-500 rounded py-3 px-4 mb-1' />
                      <p className = 'hidden form-error text-red-500 text-xs italic mx-2 mb-1'>Please fill out this field.</p>
                    </div>
                    <div className = 'mb-4'>
                      ...
                      <input name = 'byg4rv4f' type = 'email' placeholder = 'Your Email' data-validate className = 'appearance-none block w-full bg-gray-100 text-grey-darker border border-blue-500 rounded py-3 px-4 mb-1' />
                      <p className = 'hidden form-error text-red-500 text-xs italic mx-2 mb-1'>Please fill out this field.</p>
                    </div>
                    <div className = 'hidden mb-4'>
                      ...
                      <textarea name = 'message' multiline = 'true' placeholder = 'Message...' rows = '4' className = 'appearance-none block w-full bg-gray-100 text-grey-darker border border-blue-500 rounded py-3 px-4 mb-1'></textarea>
                      <p className = 'hidden form-error text-red-500 text-xs italic mx-2 mb-1'>Please fill out this field.</p>
                    </div>
                    <div className = 'mb-4'>
                      ...
                      <textarea name = 'odtbnreo' multiline = 'true' placeholder = 'Message...' rows = '4' data-validate className = 'appearance-none block w-full bg-gray-100 text-grey-darker border border-blue-500 rounded py-3 px-4 mb-1'></textarea>
                      <p className = 'hidden form-error text-red-500 text-xs italic mx-2 mb-1'>Please fill out this field.</p>
                    </div>
                    <div className = 'block'>
                      <button
                        ...
                        className = { classNames(
                          'uppercase select-none bg-blue-500 focus:shadow-outline focus:outline-none text-white text-xs font-bold py-3 px-10 rounded transform transition-background duration-500 ease-in-out',
                          {
