...
<iframe width="560" height="315" src="https://www.youtube.com/embed/nOhxOIsZjK8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br/>
...
- Go to `Plugins` page.
- Deactivate and delete the `FullPage for Elementor - Extensions` plugin if installed.
...
- Activate the `FullPage for Elementor - Extensions` plugin.
...
![FullPage for Elementor Extensions Options](assets/fullpage-for-elementor/extensions.jpg "Extensions Options")
